...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        widthCount=0;
        // Initialization code
        UILabel *riqilabel = [[UILabel alloc] initWithFrame:CGRectMake(753, 459, 105, 25)];
        riqilabel.textColor = [UIColor blackColor];
        ...
        riqilabel.text = [NSString stringWithFormat:@"%@",qianMingTimeString];
...
- (NSMutableArray *)huodeArray
{
    self.qianMingArray = [[NSMutableArray alloc] init];
    self.qianMingArray = lineArray;
    
    return self.qianMingArray;
}
