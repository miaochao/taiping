...
@protocol SmartQueryDelegate <NSObject>

-(void)smartQueryChangeCustomer;

@end

@interface SmartQueryView : UIView<UITextFieldDelegate>
{
...
@property (nonatomic,strong)  id<SmartQueryDelegate>delegate;
...
@property (strong, nonatomic) UIView *touMingView;
