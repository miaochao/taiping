...
+(void)setMethodName:(NSString*)methodName forSelectorStr:(NSString *)aSelectorStr;
...
/*!
 * CWHessianUnArchiver, a concrete subclass of @link //hessiankit_ref/occ/cl/CWHessianCoder <code>CWHessianCoder</code>@/link
...
+(void)setProtocolStr:(NSString*)aProtocolStr forClassName:(NSString*)className;
